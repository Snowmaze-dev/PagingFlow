...
interface DataSource<Key : Any, Data : Any, PagingStatus : Any> {
    ...
    val pagingUnhandledErrorsHandler: PagingUnhandledErrorsHandler<PagingStatus>? get() = null

    /**
     * Loads next page of data which can be updated when flow in result is updated
     */
    suspend fun load(loadParams: LoadParams<Key>): LoadResult<Key, Data, PagingStatus>
}